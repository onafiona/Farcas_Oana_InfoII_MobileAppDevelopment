...
public class AddExamenActivity extends AppCompatActivity {
    ...
    public void selecteazaData(View view){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                ...
                (view1, year1, month1, dayOfMonth) -> {
                    ...
                    selectedDate = year1 + "-" + String.format("%02d", month1 + 1) + "-" + String.format("%02d", dayOfMonth) + "T08:00:00Z";
    ...
    public void salveazaExamen(View view) {
        ...
        if (descriere.isEmpty() || selectedDate.isEmpty() || selectedPosition == -1) {
        ...
        try {
            ...
            jsonObject.put("data_examen", selectedDate);
        ...
        String url = "http://10.0.2.2:8000/api/examene/";

        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                response -> {
                    Toast.makeText(this, "Proiect adăugată cu succes!", Toast.LENGTH_SHORT).show();
                    finish();
                },
                error -> {
